...
export default {
    ...
    async leave(data) {
        ...
        // Step 5: Étend la sidebar vers le fullscreen (depuis la gauche)
    ...
    async afterEnter(data) {
        ...
        console.log('✨ Transition: Contact → Project Detail');
    },
};
