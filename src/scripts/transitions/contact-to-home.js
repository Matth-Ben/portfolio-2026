 ...
 * Séquence: textes out → nav links out → sidebar expand (vers la droite)
 */
export default {
    ...
    async leave(data) {
        ...
        // Step 1: Animate split text elements out (h1, contacts, email)
        ...
        // Step 4: Expand sidebar back to fullscreen (to the right)
